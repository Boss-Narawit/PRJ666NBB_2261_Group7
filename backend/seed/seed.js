...
async function seed() {
  ...
  const users = await User.insertMany([
    ...
    {
      name: 'Alex Kim',
      email: 'alex@redrobe.com',
      password: hash,
      role: 'user',
      notificationEnabled: true,
      notificationSlots: ['08:00'],
      preferences: {
        favoriteColors: ['grey', 'olive'],
        favoriteCategories: ['outerwear', 'shoes'],
        forgottenItemThresholdDays: 30,
      },
    },
    {
      name: 'Sam Park',
      email: 'sam@redrobe.com',
      password: hash,
      role: 'user',
    ...
    {
      name: 'Maya Chen',
      email: 'maya@redrobe.com',
      password: hash,
      role: 'user',
      notificationEnabled: true,
      notificationSlots: ['10:00'],
      preferences: {
    ...
    {
      name: 'Leo Park',
      email: 'leo@redrobe.com',
      password: hash,
      role: 'user',
      notificationEnabled: true,
      notificationSlots: ['07:30'],
      preferences: {
        favoriteColors: ['black', 'grey'],
        favoriteCategories: ['tops', 'shoes'],
        forgottenItemThresholdDays: 60,
      },
    },
    {
      name: 'Zoe Laurent',
      email: 'zoe@redrobe.com',
      password: hash,
      role: 'user',
      notificationEnabled: true,
      notificationSlots: ['09:00', '20:00'],
      preferences: {
        favoriteColors: ['brown', 'cream', 'rust'],
    ...
    {
      name: 'Kai Torres',
      email: 'kai@redrobe.com',
      password: hash,
      role: 'user',
      notificationEnabled: true,
      notificationSlots: ['06:00'],
      preferences: {
        favoriteColors: ['black', 'white'],
        favoriteCategories: ['shoes', 'outerwear'],
        forgottenItemThresholdDays: 30,
      },
    },
    {
      name: 'Emma Wilson',
      email: 'emma@redrobe.com',
      password: hash,
      role: 'user',
  ...
  const [, janeId, alexId, samId, mayaId, leoId, zoeId, kaiId, emmaId, ryanId] = users.map(
    (u) => u._id
  );
  ...
  const partners = await Partner.insertMany([
    ...
    },
    {
      ...
      email: 'consign@therealreal.com',
      description: 'Luxury consignment marketplace',
      apiEndpoint: 'https://api.therealreal.com/listings',
      isActive: true,
    },
    {
      name: 'Tailor & Co',
    ...
    }, // BR30: hidden
    {
      ...
      apiEndpoint: 'https://api.poshmark.com/v2/listings',
      isActive: true,
    },
    {
      name: 'Depop',
      ...
      email: 'sellers@depop.com',
      description: 'Trend-driven secondhand marketplace',
      apiEndpoint: 'https://api.depop.com/v1/listings',
      isActive: true,
    },
    {
      ...
      email: 'trade@buffaloexchange.com',
      description: 'Buy, sell, and trade clothing',
      isActive: true,
    },
    {
      name: 'Salvation Army',
      ...
      email: 'donate@salvationarmy.org',
      description: 'Clothing donations for communities in need',
      isActive: true,
    },
    {
      name: 'Remake',
  ...
  const janeClothing = await Clothing.insertMany([
    ...
    /* [1]  */ {
      ...
      analytics: { wearCount: 20, lastWornAt: midnight(6) },
    },
    /* [2]  */ {
      userId: janeId,
    ...
    /* [4]  */ {
      ...
      analytics: { wearCount: 30, lastWornAt: midnight(2) },
    },
    /* [5]  */ {
      userId: janeId,
      name: 'Silk Scarf',
      ...
      purchasePrice: 25.0,
      tags: ['accessories'],
      analytics: { wearCount: 1, lastWornAt: midnight(60), lastNotifiedAt: new Date() },
    },
    /* [6]  */ {
      userId: janeId,
      name: 'Grey Hoodie',
    ...
    /* [9]  */ {
      ...
      condition: 'Good',
      status: 'Archived',
      imageUrl: 'https://images.unsplash.com/photo-1576995883346-6cee8e39ad3f',
      purchasePrice: 65.0,
      tags: ['casual'],
    ...
    /* [10] */ {
      ...
      condition: 'Excellent',
      status: 'Available',
      imageUrl: 'https://images.unsplash.com/photo-1598033129183-c4f50c7176c8',
      purchasePrice: 55.0,
      purchaseDate: new Date('2024-06-01'),
      tags: ['summer', 'casual'],
      analytics: { wearCount: 6 },
    },
    /* [11] */ {
      userId: janeId,
    ...
    /* [13] */ {
      ...
      analytics: { wearCount: 22, lastWornAt: midnight(1) },
    },
    /* [14] */ {
      userId: janeId,
      ...
      condition: 'Good',
      status: 'Available',
      imageUrl: 'https://images.unsplash.com/photo-1539109132314-34a77ae7092b',
      purchasePrice: 199.0,
  ...
  const alexClothing = await Clothing.insertMany([
    /* [0] */ {
      ...
      condition: 'Good',
      status: 'Available',
      imageUrl: 'https://images.unsplash.com/photo-1617113930975-f9c7243ae527',
      purchasePrice: 130.0,
      tags: ['outdoor', 'casual'],
    ...
    /* [1] */ {
      ...
      condition: 'Excellent',
      status: 'Available',
      imageUrl: 'https://images.unsplash.com/photo-1473966968600-fa804b86d47b',
      purchasePrice: 79.0,
      tags: ['work', 'smart casual'],
      analytics: { wearCount: 14, lastWornAt: midnight(3) },
    },
    /* [2] */ {
      userId: alexId,
      name: 'Running Shoes',
      ...
      condition: 'Good',
      status: 'Available',
      imageUrl: 'https://images.unsplash.com/photo-1587563877366-26d526223d22',
      purchasePrice: 110.0,
      tags: ['sport', 'everyday'],
      analytics: { wearCount: 25, lastWornAt: midnight(1) },
    },
    /* [3] */ {
      userId: alexId,
      ...
      condition: 'Excellent',
      status: 'Available',
      imageUrl: 'https://images.unsplash.com/photo-1611312449412-6cefac5dc3e4',
      purchasePrice: 60.0,
      tags: ['work', 'minimal'],
      analytics: { wearCount: 18 },
    },
    /* [4] */ {
      userId: alexId,
      name: 'Chelsea Boots',
  ...
  await Clothing.insertMany([
    ...
    },
    {
      ...
      condition: 'Good',
      status: 'Available',
      imageUrl: 'https://images.unsplash.com/photo-1544816153-09730bc47d3d',
      purchasePrice: 55.0,
      tags: ['everyday'],
      analytics: { wearCount: 0 },
    },
  ...
  const leoClothing = await Clothing.insertMany([
    ...
    /* [1] */ {
      ...
      purchasePrice: 185.0,
      tags: ['work', 'smart casual'],
      analytics: { wearCount: 4, lastWornAt: midnight(65) },
    },
    /* [2] */ {
      userId: leoId,
      name: 'Oxford Shoes',
  ...
  const zoeClothing = await Clothing.insertMany([
    ...
    /* [2] */ {
      ...
      analytics: { wearCount: 20, lastWornAt: midnight(2) },
    },
    /* [3] */ {
      userId: zoeId,
      ...
      purchasePrice: 12.0,
      tags: ['vintage', 'casual'],
      analytics: { wearCount: 1, lastWornAt: midnight(35) },
    },
  ]);
  ...
  const kaiClothing = await Clothing.insertMany([
    /* [0] */ {
      ...
      condition: 'Good',
      status: 'Available',
      imageUrl: 'https://images.unsplash.com/photo-1519058082700-08a515d1a41a',
      purchasePrice: 65.0,
      tags: ['sport', 'everyday'],
      analytics: { wearCount: 22, lastWornAt: midnight(1) },
    },
    ...
    /* [2] */ {
      ...
      purchasePrice: 145.0,
      tags: ['sport', 'trail'],
      analytics: { wearCount: 35, lastWornAt: midnight(1) },
    },
  ]);
  ...
  await Outfit.insertMany([
    ...
    },
    {
      userId: janeId,
      name: 'Winter Layers',
      clothingItems: [jC[12], jC[14], jC[8]],
      occasion: 'work',
      season: 'winter',
      rating: 4,
    },
  ...
  const buildLogs = (userId, availableItems, count, dayRange) => {
    ...
    while (usedDays.size < count) {
      ...
      if (!usedDays.has(daysAgo)) {
        ...
        const worn = shuffled
          .slice(0, Math.min(numItems, shuffled.length))
          .map((itemId) => ({ itemId }));
  ...
  const janePurchases = await ThoughtfulPurchase.insertMany([
    {
      ...
      imageUrl: 'https://images.unsplash.com/photo-1591047139829-d91aecb6caea',
      estimatedPrice: 250,
      sourceUrl: 'https://zara.com/camel-coat',
      cooldownEndsAt: new Date(Date.now() + 48 * 60 * 60 * 1000),
      status: 'pending',
    },
    {
      userId: janeId,
      itemName: 'Red Mini Dress',
      description: 'Bright red cocktail dress.',
      imageUrl: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8',
      estimatedPrice: 89,
      cooldownEndsAt: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000),
      status: 'approved',
    },
    {
      userId: janeId,
      itemName: 'Platform Sneakers',
      description: 'White platform trend sneakers.',
      imageUrl: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff',
      estimatedPrice: 120,
      cooldownEndsAt: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000),
      status: 'rejected',
    },
  ]);
  ...
  const [ap0] = (
    await ThoughtfulPurchase.insertMany([
      {
        userId: alexId,
        itemName: 'Leather Weekender Bag',
        description: 'Full-grain leather bag for travel.',
        imageUrl: 'https://images.unsplash.com/photo-1547949003-9792a18a2601',
        estimatedPrice: 180,
        cooldownEndsAt: new Date(Date.now() + 24 * 60 * 60 * 1000),
        status: 'pending',
      },
    ])
  ).map((p) => p._id);
  ...
  const mayaPurchases = await ThoughtfulPurchase.insertMany([
    {
      userId: mayaId,
      itemName: 'Leopard Print Blouse',
      description: 'Statement blouse for evenings.',
      imageUrl: 'https://images.unsplash.com/photo-1515372039744-b8f02a3ae446',
      estimatedPrice: 72,
      cooldownEndsAt: new Date(Date.now() + 24 * 60 * 60 * 1000),
      status: 'pending',
    },
    {
      ...
      description: 'Champagne satin skirt, elegant.',
      imageUrl: 'https://images.unsplash.com/photo-1583337130417-3346a1be7dee',
      estimatedPrice: 95,
      cooldownEndsAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000),
      status: 'approved',
    },
  ]);
  ...
  const [lp0] = (
    await ThoughtfulPurchase.insertMany([
      {
        userId: leoId,
        itemName: 'Cashmere V-Neck Sweater',
        description: 'Navy cashmere sweater.',
        imageUrl: 'https://images.unsplash.com/photo-1434389677669-e08b4cac3105',
        estimatedPrice: 210,
        cooldownEndsAt: new Date(Date.now() + 36 * 60 * 60 * 1000),
        status: 'pending',
      },
    ])
  ).map((p) => p._id);
  ...
  const [zp0] = (
    await ThoughtfulPurchase.insertMany([
      {
        userId: zoeId,
        itemName: 'Cognac Leather Belt',
        description: 'Wide leather belt, earthy tones.',
        imageUrl: 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa',
        estimatedPrice: 65,
        cooldownEndsAt: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000),
        status: 'rejected',
      },
    ])
  ).map((p) => p._id);
  ...
  const kaiPurchases = await ThoughtfulPurchase.insertMany([
    {
      userId: kaiId,
      itemName: 'Yoga Mat Bag',
      description: 'Carrying bag for yoga mat.',
      imageUrl: 'https://images.unsplash.com/photo-1544816153-09730bc47d3d',
      estimatedPrice: 45,
      cooldownEndsAt: new Date(Date.now() + 30 * 60 * 60 * 1000),
      status: 'pending',
    },
    {
      userId: kaiId,
      itemName: 'Compression Leggings',
      description: 'High-waist compression leggings.',
      imageUrl: 'https://images.unsplash.com/photo-1519058082700-08a515d1a41a',
      estimatedPrice: 88,
      cooldownEndsAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000),
      status: 'approved',
    },
  ]);
  ...
  await Export.insertMany([
    ...
    },
    {
      userId: janeId,
      clothingId: jC[11],
      partnerId: goodwillId,
      type: 'donation',
      status: 'donated',
      checklistCompleted: true,
      consent: true,
      selectedFields: ['name', 'colors', 'condition'],
    },
    {
      userId: janeId,
      clothingId: jC[15],
      partnerId: goodwillId,
      type: 'donation',
      description: 'Worn denim shorts.',
      status: 'active',
      checklistCompleted: true,
      consent: true,
      selectedFields: ['name', 'condition'],
    }, // Damaged → donation only (BR21)
    // Alex
    {
      userId: alexId,
      clothingId: aC[5],
      partnerId: salvationArmyId,
      type: 'donation',
      status: 'donated',
      checklistCompleted: true,
      consent: true,
      selectedFields: ['name', 'brand', 'condition'],
    },
    // Maya
    {
      userId: mayaId,
      clothingId: mC[2],
      partnerId: realRealId,
      type: 'resale',
      price: 120,
      description: 'Burberry trench, great condition.',
      status: 'active',
      checklistCompleted: true,
      consent: true,
      selectedFields: ['name', 'brand', 'size', 'condition', 'imageUrl'],
    },
    {
      userId: mayaId,
      clothingId: mC[3],
      ...
      type: 'resale',
      price: 18,
      description: 'Yellow sundress, like new.',
      status: 'active',
      checklistCompleted: true,
      consent: true,
      selectedFields: ['name', 'colors', 'condition', 'imageUrl'],
    },
    // Leo
    {
      userId: leoId,
    ...
    // Kai
    {
      ...
      partnerId: remakeId,
      type: 'upcycle',
      description: 'Sports bra for upcycling.',
      status: 'active',
      checklistCompleted: true,
      consent: true,
      selectedFields: ['name', 'brand', 'colors', 'condition'],
    }, // Fair → upcycle, not resale
    // Emma
    {
      userId: emmaId,
      clothingId: eC[0],
      partnerId: poshmarkId,
      type: 'resale',
      price: 85,
      description: 'Cashmere cardigan, barely worn.',
      status: 'active',
      checklistCompleted: true,
      consent: true,
      selectedFields: ['name', 'brand', 'size', 'condition', 'imageUrl'],
  ...
  await Notification.insertMany([
    // Jane (5)
    {
      userId: janeId,
      type: 'forgotten_item',
      message: "You haven't worn your Silk Scarf in over 60 days. Time to rediscover it!",
      isRead: false,
      relatedId: jC[5],
    },
    {
      ...
      message:
        'The Camel Wool Coat you want is 91% similar to your Wool Camel Coat. Do you really need it?',
      isRead: false,
      relatedId: jp0,
    },
    {
      userId: janeId,
      type: 'similarity_alert',
      message: 'The Camel Wool Coat is also 82% similar to your Navy Blazer.',
      isRead: true,
      relatedId: jp0,
    },
    {
      ...
      message: 'Your cooling-off period for Red Mini Dress has ended. Ready to decide?',
      isRead: true,
      relatedId: jp1,
    },
    {
      userId: janeId,
      type: 'recap_ready',
      message: 'Your 2024 Style Recap is ready! You wore 142 items across 38 outfits.',
      isRead: false,
    },
    // Alex (2)
    {
      userId: alexId,
      type: 'cooldown_reminder',
      message: 'Your cooling-off period for Leather Weekender Bag ends in 2 hours.',
      isRead: false,
      relatedId: ap0,
    },
    {
      userId: alexId,
      type: 'export_update',
      message: 'Your Puffer Vest has been successfully donated.',
      isRead: true,
    },
    // Maya (2)
    {
      ...
      type: 'similarity_alert',
      message:
        'The Leopard Print Blouse is 73% similar to your Red Wrap Dress. Consider wearing what you have!',
      isRead: false,
      relatedId: mp0,
    },
    {
      userId: mayaId,
      type: 'cooldown_reminder',
      message: 'Your cooling-off period for Satin Midi Skirt has ended. Ready to decide?',
      isRead: true,
      relatedId: mp1,
    },
    // Leo (1)
    {
      userId: leoId,
      type: 'forgotten_item',
      message: "You haven't worn your Grey Wool Trousers in over 65 days.",
      isRead: false,
      relatedId: lC[1],
    },
    // Zoe (1)
    {
      userId: zoeId,
      type: 'forgotten_item',
      message: "Your Vintage Denim Vest hasn't been worn in over 35 days. Give it another chance!",
      isRead: false,
      relatedId: zC[3],
    },
    // Kai (1)
    {
      userId: kaiId,
      type: 'cooldown_reminder',
      message: 'Your cooling-off period for Yoga Mat Bag ends in 6 hours. Still want it?',
      isRead: false,
      relatedId: kp0,
    },
  ]);
